...
ImageHostData run_grmhd_image_spherical_ks(
    ...
    return kpolaris_image_detail::run_image_metric_with_optional_split(
        pass_a, model, radiation_substeps, timing, split_transport, metric, "spherical_ks");
}
...
ImageHostData run_grmhd_multifrequency_image_spherical_ks(
    ...
    return kpolaris_image_detail::run_multifrequency_image_metric_with_step_control(
        pass_a, model, radiation_substeps, frequencies, step_control_frequencies, timing, metric, "spherical_ks");
}
#endif
